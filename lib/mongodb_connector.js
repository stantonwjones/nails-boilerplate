...
MongoDBConnector.prototype.put = function(model_or_collection) {
    if (model_or_collection.is_model)
        return this._put_one(model_or_collection._collection_name(), model_or_collection.attributes);
}
MongoDBConnector.prototype._put_one = function(collection_name, doc) {
    ...
    // TODO: write concerns?
    return this._db.collection(collection_name).update({_id: doc._id}, doc);
}
/**
