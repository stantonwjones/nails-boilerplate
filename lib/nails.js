...
function configure( app_config ) {
    ...
    console.warn('initializing controllers: ', app_config.controllers);
...
function init_app_lib(base_constructor, lib) {
    ...
    for (var key in lib) {
        ...
        if (typeof constructor == 'function') base_constructor.extend(constructor);
        else throw new Error('Invalid controller constructor: ' + constructor);
    }
}
