...
Router.prototype.route = function( request, response ) {
    ...
    console.log('route params are: ', JSON.stringify(routeParams));
...
Router.prototype.get_dispatch_params = function( method, path, query) {
    ...
    var params = this.get_static_file_params(matched_route) ||
...
Router.prototype.get_matched_route = function( method, path ) {
    for ( var i = 0; i < this.routes.length; i++ ) {
        ...
        console.log('checking route', this.routes[i], 'against', path );
