...
Router.prototype.route = function( request, response ) {
    ...
    if ( !request.parsed_form && request.method.match(/^(post|put)$/i) ) return this.handle_incoming_form(request, response);
    /*
    ...
    */
    ...
    var routeParams = this.get_dispatch_params( method, uri.pathname, querystring.parse(uri.query), request.form_fields, request.files );
...
Router.prototype.get_dispatch_params = function( method, path, query, form_fields, files) {
    ...
    _.extend(params.params, query, form_fields, files);
