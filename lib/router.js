...
Router.prototype.setPublicDir = function( public_dir ) {
...
Router.prototype.addRoute = function( route ) {
    ...
    var public_path = this.public_dir + path_matcher;
    var consequences = route[2];
    if (consequences.public)
        return this.application.use(this.application.static(this.public_dir));
    var handler = this.get_express_route_handler(consequences);
    this.express_router[method](path_matcher, handler);
};
