...
var Nails = global.Nails || require('nails-boilerplate');
...
function Controller( constructor ) {
    ...
    appRouter.removeAllListeners('dispatchTo:' + controller_name);
    appRouter.on('dispatchTo:' + controller_name, this._do.bind(this));
