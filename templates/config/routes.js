...
// CHANGING THE NAME OF THE ROUTES ARRAY BREAKS EVERYTHING
var routes = [
	...
	// Example route which routes the first part of pathname to controller and the second to the action
	// ['get', /^\/(\w+)\/(\w+)$/i, {1: 'controller', 2: 'action'}]
];

// CHANGING THE FOLLOWING LINE BREAKS EVERYTHING
